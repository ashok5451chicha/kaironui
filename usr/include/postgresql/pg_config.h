...
#define PG_VERSION "11.12 (Debian 11.12-0+deb10u1)"

/* PostgreSQL version as a number */
#define PG_VERSION_NUM 110012

/* A string containing the version number, platform, and C compiler */
#define PG_VERSION_STR "PostgreSQL 11.12 (Debian 11.12-0+deb10u1) on x86_64-pc-linux-gnu, compiled by gcc (Debian 8.3.0-6) 8.3.0, 64-bit"
